...
extern void            (APIENTRY * qglMultiTexCoord2f) (GLenum target, GLfloat s, GLfloat t);

extern void            (APIENTRY * qglBindAttribLocation) (GLuint programObj, GLuint index, const GLchar * name);
extern void            (APIENTRY * qglGetActiveAttrib) (GLuint programObj, GLuint index, GLsizei maxLength, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
extern GLint(APIENTRY * qglGetAttribLocation) (GLuint programObj, const GLchar * name);
extern void            (APIENTRY * qglVertexAttrib4f) (GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
extern void            (APIENTRY * qglVertexAttrib4fv) (GLuint, const GLfloat *);
...
extern void (APIENTRY * qglGetBufferSubData) (GLenum target, GLintptr offset, GLsizeiptr size, GLvoid * data);
...
extern void (APIENTRY * qglDeleteObject) (GLuint obj);
extern GLuint(APIENTRY * qglGetHandle) (GLenum pname);
extern void (APIENTRY * qglDetachObject) (GLuint containerObj, GLuint attachedObj);
...
extern void (APIENTRY * qglAttachObject) (GLuint containerObj, GLuint obj);
...
extern void (APIENTRY * qglGetObjectParameterfv) (GLuint obj, GLenum pname, GLfloat * params);
extern void (APIENTRY * qglGetObjectParameteriv) (GLuint obj, GLenum pname, GLint * params);
extern void (APIENTRY * qglGetInfoLog) (GLuint obj, GLsizei maxLength, GLsizei * length, GLchar * infoLog);
extern void (APIENTRY * qglGetAttachedObjects) (GLuint containerObj, GLsizei maxCount, GLsizei * count, GLuint * obj);
extern GLint(APIENTRY * qglGetUniformLocation) (GLuint programObj, const GLchar * name);
extern void (APIENTRY * qglGetActiveUniform) (GLuint programObj, GLuint index, GLsizei maxIndex, GLsizei * length, GLint * size, GLenum * type, GLchar * name);
...
extern void (APIENTRY * qglGetCompressedTexImage)(GLenum target, GLint lod, GLvoid *img);
...
extern GLvoid (APIENTRY * qglTextureImage2D)(GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
extern GLvoid (APIENTRY * qglTextureSubImage2D)(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
extern GLvoid (APIENTRY * qglCopyTextureImage2D)(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border);
extern GLvoid (APIENTRY * qglCompressedTextureImage2D)(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data);
extern GLvoid (APIENTRY * qglCompressedTextureSubImage2D)(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data);
...
extern GLvoid(APIENTRY * qglProgramUniform2f)(GLuint program, GLint location, GLfloat v0, GLfloat v1);
extern GLvoid(APIENTRY * qglProgramUniform3f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
extern GLvoid(APIENTRY * qglProgramUniform4f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
extern GLvoid(APIENTRY * qglProgramUniform1fv)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
extern GLvoid(APIENTRY * qglProgramUniformMatrix4fv)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
extern GLvoid(APIENTRY * qglNamedRenderbufferStorage)(GLuint renderbuffer, GLenum internalformat, GLsizei width, GLsizei height);
extern GLvoid(APIENTRY * qglNamedRenderbufferStorageMultisample)(GLuint renderbuffer, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
extern GLenum(APIENTRY * qglCheckNamedFramebufferStatus)(GLuint framebuffer, GLenum target);
extern GLvoid(APIENTRY * qglNamedFramebufferTexture2D)(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
extern GLvoid(APIENTRY * qglNamedFramebufferRenderbuffer)(GLuint framebuffer, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
