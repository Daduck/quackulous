...
commands_t cmds[ ] = {
  ...
  { "nav_add", CMD_CHEAT, NAV_Command_f },
  { "nav_autolink", CMD_CHEAT, NAV_Command_f },
  { "nav_del", CMD_CHEAT, NAV_Command_f },
  { "nav_link", CMD_CHEAT, NAV_Command_f },
  { "nav_load", CMD_CHEAT, NAV_Command_f },
  { "nav_save", CMD_CHEAT, NAV_Command_f },
  { "nav_stats", 0, NAV_Command_f },
